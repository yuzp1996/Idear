...
urlpatterns = [
    ...
    url(r'^project/deleteRecruit$', views.delete_recruit),
    url(r'^project/modifyRecruit$', views.modify_recruit),
    url(r'^project/recruit$', views.project_recruit, name='project_recruit'),
    url(r'^project/delete/(?P<deleteId>(\d+))$', views.project_delete),
    url(r'^project/deleteProject$', views.project_deleteProject),
    ...
    url(r'^user_update$', views.user_update, name='user_delete'),
    ...
    url(r'^creation/modify', views.creation_modify, name='creation_modify'),
    ...
    url(r'^newsalluser$', views.allUserMail,name='allUserMail'),
    url(r'^getallmail$', views.getallmail,name='getallmail'),
